...
<body>
	...
	<!-- CONTEÚDO DO SISTEMA -->
        <div id="conteudo"> 
            <!-- BARRA DE TÍTULO -->
            <div id="barraTitulo">
                <span class="legenda">Dados do Usuário - <label style="color: white;"><?php echo $login; ?></label></span> 
            </div>           
            ...
            <div id="cadastro">
                <span class="tableBlock">			
                    <span class="tableCell">
                        ...
                        <input name="idUsuario" id="idUsuario" type="hidden" value="<?php echo $_COOKIE['idUsuario']; ?>">
                    </span>
                </span>
                <span class="tableBlock">			
                    <span class="tableCell">
